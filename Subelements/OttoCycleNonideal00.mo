...
block OttoCycleNonideal00
  ...
  Modelica.Blocks.Interfaces.RealInput u_fracFuel annotation(
    Placement(visible = true, transformation(origin = {-120, 80}, extent = {{-20, -20}, {20, 20}}, rotation = 0), iconTransformation(origin = {-114, 40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Interfaces.RealInput u_effComb annotation(
    Placement(visible = true, transformation(origin = {-120, 40}, extent = {{-20, -20}, {20, 20}}, rotation = 0), iconTransformation(origin = {-114, 80}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  Modelica.Blocks.Interfaces.RealInput par_LHV_fuel(displayUnit = "J/kg", unit = "J/kg") annotation(
  ...
  Modelica.Blocks.Interfaces.RealOutput y_m_fuel(quantity = "Mass", unit = "kg", displayUnit = "kg") annotation(
    Placement(visible = true, transformation(origin = {110, 50}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {114, 40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
