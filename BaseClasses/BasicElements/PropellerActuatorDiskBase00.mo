...
partial model PropellerActuatorDiskBase00
 ...
 /* ---------------------------------------------
  ...
  Modelica.Units.SI.Power pwr(start=pwr_init) "power driving propeller" annotation(
    Dialog(tab = "Variables", group = "start attribute", enable = false, showStartAttribute = true));
  Modelica.Units.SI.Power pwrPropulsive(start=pwr_init*0.8) "propulsive power, defined by Fg*Vin" annotation(
    Dialog(tab = "Variables", group = "start attribute", enable = false, showStartAttribute = true));
  Modelica.Units.SI.Torque trq(start=tau1_init) "torque of drive shaft" annotation(
    Dialog(tab = "Variables", group = "start attribute", enable = false, showStartAttribute = true));
  Modelica.Units.SI.AngularVelocity omega(start=Nmech_init*2*Modelica.Constants.pi/60.0) "mechanical rotation speed, rad/sec" annotation(
    Dialog(tab = "Variables", group = "start attribute", enable = false, showStartAttribute = true));
  ...
  Real Nmech_rps(start=Nmech_init/60.0) "rev/s" annotation(
    Dialog(tab = "Variables", group = "start attribute", enable = false, showStartAttribute = true));
  Modelica.Units.SI.Force Fn(start=pwr_init*0.8/100) "thrust generated by propeller" annotation(
    Dialog(tab = "Variables", group = "start attribute", enable = false, showStartAttribute = true));
  Modelica.Units.SI.Velocity Vinf(start=100) "freestream speeed" annotation(
    Dialog(tab = "Variables", group = "start attribute", enable = false, showStartAttribute = true));
...
protected
  ...
  parameter Real effPropDes(fixed = false) annotation(
    HideResult = false);
  parameter Modelica.Units.NonSI.AngularVelocity_rpm NmechDes(fixed=false, start= Nmech_init) "" annotation(
    HideResult=false);
