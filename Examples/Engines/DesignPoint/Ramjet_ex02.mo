...
equation
  //-----
  arr_h[1]= Flt2Fluid.AltMN2pTh.fluidAmb.h;
  arr_h[2]= Comb.fluid_1.h;
  arr_h[3]= Comb.fluid_2.h;
  arr_h[4]= Nzl.fluid_2.h;
  arr_h[5]= arr_h[1];
  arr_s[1]= Flt2Fluid.s_fluid_amb;
  arr_s[2]= Comb.s_fluid_1;
  arr_s[3]= Comb.s_fluid_2;
  arr_s[4]= Nzl.s_fluid_2;
  arr_s[5]= arr_s[1];
  //-----
